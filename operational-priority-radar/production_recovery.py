 ...
 def run(self):
  try:
   ...
   for sym in self.symbols:
    ...
    starts=[x.get("decision_available_ts") for x in (e,b) if x]
    anchor=min((datetime.fromisoformat(x.replace("Z","+00:00")) for x in starts),default=now-timedelta(minutes=60))
