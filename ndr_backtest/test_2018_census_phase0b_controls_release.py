...
class ReleaseTests(unittest.TestCase):
    def test_version_build(self):
        self.assertIn('VERSION = "1.7.56"',S); self.assertIn('2018-CENSUS-PHASE0B-CONTROLS-A',S)
    ...
    def test_exact_control_constants(self):
        self.assertIn('j*7919',S); self.assertIn('base+104729',S); self.assertIn('Phase 0B failed clean candidates',S)
